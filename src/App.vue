  ...
  methods: {
    ...
    checkIsWinner() {
      ...
      if (
        ...
        (this.itemArray[0] === "cross" || this.itemArray[0] ==="circle") &&
        (this.itemArray[1] === "cross" || this.itemArray[1] ==="circle") &&
        (this.itemArray[2] === "cross" || this.itemArray[2] ==="circle")&&
        (this.itemArray[3] === "cross" || this.itemArray[3] ==="circle") &&
        (this.itemArray[4] === "cross" || this.itemArray[4] ==="circle") &&
        (this.itemArray[5] === "cross" || this.itemArray[5] ==="circle")&&
        (this.itemArray[6] === "cross" || this.itemArray[6] ==="circle") &&
        (this.itemArray[7] === "cross" || this.itemArray[7] ==="circle") &&
        (this.itemArray[8] === "cross" || this.itemArray[8] ==="circle")
      ){
